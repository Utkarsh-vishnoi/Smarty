...
public class ThingSpeakChannel {
     ...
     */
    public ThingSpeakChannel(long channelId, String API) {
     ...
     * @param API The address of the custom thingspeak server API.
     */
    public ThingSpeakChannel(long channelId, String readApiKey, String API) {
        THINGSPEAK_API = API;
    ...
    /***
     * Set the {@link com.example.utkarsh.thingspeakandroid.ThingSpeakChannel.ChannelFeedUpdateListener} to use.
     *
    ...
    /***
     * Set the {@link com.example.utkarsh.thingspeakandroid.ThingSpeakChannel.FeedEntryUpdateListener} to use.
     *
     * @param listener The listener.
     */
    ...
    /***
     * Set the {@link com.example.utkarsh.thingspeakandroid.ThingSpeakChannel.ChannelFieldFeedUpdateListener} to use.
     *
     * @param listener The listener.
     */
    ...
    /***
     * Set the {@link com.example.utkarsh.thingspeakandroid.ThingSpeakChannel.ChannelStatusUpdateListener} to use.
     *
     * @param listener The listener.
     */
